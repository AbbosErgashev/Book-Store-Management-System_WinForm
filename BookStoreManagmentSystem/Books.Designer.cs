namespace BookStoreManagmentSystem
{
    partial class Books
    {
        ...
        private void InitializeComponent()
        {
            ...
            label5 = new Label();
            BUpdateBtn = new Button();
            BDeleteBtn = new Button();
            BResetBtn = new Button();
            BRefreshBtn = new Button();
            SaveBtn = new Button();
            BCatCb = new ComboBox();
            ...
            panel2.Controls.Add(BUpdateBtn);
            panel2.Controls.Add(BDeleteBtn);
            panel2.Controls.Add(BResetBtn);
            panel2.Controls.Add(BRefreshBtn);
            panel2.Controls.Add(SaveBtn);
            panel2.Controls.Add(BCatCb);
            panel2.Controls.Add(BPriceTb);
            panel2.Controls.Add(BQuanTb);
        ...
        private TextBox BQuanTb;
        private TextBox BautTb;
        private Button SaveBtn;
        private Button BUpdateBtn;
        private Button BDeleteBtn;
        private Button BResetBtn;
        private Button BRefreshBtn;
        private ComboBox CatFiltrCb;
